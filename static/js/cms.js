...
var _serving = __webpack_require__(32);

CMS.registerPreviewStyle('/static/css/stcs.css');
CMS.registerPreviewTemplate('our-team', _ourTeam.OurTeamPreview);
CMS.registerPreviewTemplate('serving', _serving.ServingPreview);
...
exports.OurTeamPreview = undefined;
...
function members(team) {
  return team.getIn(['data', 'members']).map(function (member) {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'thumbnail' },
        _react2.default.createElement('img', { src: member.get('picture') })
      ),
      _react2.default.createElement(
        'div',
        { className: 'caption' },
...
var OurTeamPreview = createClass({
  render: function render() {
    ...
    var rows = this.props.widgetsFor('teams').map(function (team, index) {
      return _react2.default.createElement(
        'div',
        { className: 'container' },
        _react2.default.createElement(
...
exports.OurTeamPreview = OurTeamPreview;
...
exports.ServingPreview = undefined;
...
exports.ServingPreview = ServingPreview;
