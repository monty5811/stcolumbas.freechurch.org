...
window.$ = $;
window.jQuery = $;
var bs = __webpack_require__(9);
var pay = __webpack_require__(22);

function gMap() {
  $(document).ready(function ($) {
    var center = new google.maps.LatLng(55.948845, -3.194091999999955);
    var map_pin = new google.maps.MarkerImage('/static/images/icons/mapmarker-icon-76x106.png');
    ...
    var map = new google.maps.Map($('#map-container1')[0], mapOptions);
    var title = '';
    var churchMarker = new google.maps.Marker({
      position: center,
      map: map,
      icon: map_pin,
      url: "https://www.google.co.uk/maps/place/St+Columba's+Free+Church+of+Scotland"
    });
...
function init() {
  ...
  // google map:
  var mapElem = document.getElementById('map-container1');
  if (mapElem !== null) {
    gMap();
  }
}
...
var Elm = __webpack_require__(23);
...
function init() {
  ...
  if (elmContainer !== null) {
    var stripeTokenHandler = function stripeTokenHandler(result) {
...
var _user$project$Payments$chargeBody = F3(
	function (amount, token, data) {
					...
					_1: {
						...
						_1: {
							...
							_0: {
								ctor: '_Tuple2',
								_0: 'fund',
								_1: _elm_lang$core$Json_Encode$string(data.fund)
							},
							_1: {
								ctor: '::',
								_0: {
								...
								_1: {
									...
									_0: {
										...
										_1: _elm_lang$core$Json_Encode$int(
											_elm_lang$core$Basics$round(amount * 100))
									},
									_1: {ctor: '[]'}
								}
							}
...
var _user$project$Payments$niceHttpErr = function (err) {
	var _p0 = err;
	switch (_p0.ctor) {
		case 'BadUrl':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Server error, your card should not have been charged, but please contact the office to make sure before trying again.'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			};
		case 'Timeout':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Request timed out (it took too long).'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('I do not know if your card was charged successfully, please contact the office and we will happily check for you.'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		case 'NetworkError':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('There was a network error, maybe your internet dropped out?'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
		...
		case 'BadStatus':
			return {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('The error message provided by our payments provider (Stripe) was:'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p0._0.body),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Payments$view = function (model) {
	var _p1 = model.state;
	switch (_p1.ctor) {
		case 'WaitingForForm':
			return _elm_lang$html$Html$text('');
		case 'WaitingForStripeToken':
			return A2(
			...
			return A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Uh oh, something went wrong there.'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('The issue happened before we tried to charge your card.'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Please refresh this page and try again.'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
		...
		case 'Complete':
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Thank you for your donation!'),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
					...
					_elm_lang$core$Basics_ops['++'],
					{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('The issue happened as we were trying to charge your card:'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					},
					_user$project$Payments$niceHttpErr(_p1._0)));
	}
};
var _user$project$Payments$stripeResult = _elm_lang$core$Native_Platform.incomingPort('stripeResult', _elm_lang$core$Json_Decode$value);
var _user$project$Payments$startLoading = _elm_lang$core$Native_Platform.incomingPort(
	'startLoading',
	_elm_lang$core$Json_Decode$null(
		{ctor: '_Tuple0'}));
var _user$project$Payments$Model = F2(
	function (a, b) {
		return {state: a, serverAwake: b};
	});
var _user$project$Payments$FormData = F5(
	function (a, b, c, d, e) {
		return {name: a, amount: b, email: c, fund: d, result: e};
	});
var _user$project$Payments$StripeResult = F2(
	function (a, b) {
		return {token: a, error: b};
	});
var _user$project$Payments$StripeToken = function (a) {
	return {id: a};
};
var _user$project$Payments$stripeTokenDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'id',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Payments$StripeToken));
var _user$project$Payments$StripeError = F5(
	function (a, b, c, d, e) {
		return {charge: a, message: b, code: c, declineCode: d, param: e};
	});
var _user$project$Payments$stripeErrorDecoder = A4(
		...
		A4(
			...
			A4(
				...
				A3(
					...
					'charge',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Payments$StripeError))))));
var _user$project$Payments$stripeResultDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'error',
	_elm_lang$core$Json_Decode$maybe(_user$project$Payments$stripeErrorDecoder),
	_elm_lang$core$Maybe$Nothing,
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'token',
		_elm_lang$core$Json_Decode$maybe(_user$project$Payments$stripeTokenDecoder),
		_elm_lang$core$Maybe$Nothing,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Payments$StripeResult)));
var _user$project$Payments$formDataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'result',
	_user$project$Payments$stripeResultDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'fund',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			A3(
				...
				A3(
					...
					'name',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Payments$FormData))))));
var _user$project$Payments$Failed = function (a) {
	return {ctor: 'Failed', _0: a};
};
var _user$project$Payments$Complete = {ctor: 'Complete'};
var _user$project$Payments$WaitingForServer = {ctor: 'WaitingForServer'};
var _user$project$Payments$BadInputData = function (a) {
	return {ctor: 'BadInputData', _0: a};
};
var _user$project$Payments$WaitingForStripeToken = {ctor: 'WaitingForStripeToken'};
var _user$project$Payments$WaitingForForm = {ctor: 'WaitingForForm'};
var _user$project$Payments$WaitForStripeToken = {ctor: 'WaitForStripeToken'};
var _user$project$Payments$FromJs = function (a) {
	return {ctor: 'FromJs', _0: a};
};
var _user$project$Payments$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Payments$stripeResult(_user$project$Payments$FromJs),
			_1: {
				ctor: '::',
				_0: _user$project$Payments$startLoading(
					function (_p2) {
						return _user$project$Payments$WaitForStripeToken;
					}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Payments$WakeUpResponseReceived = function (a) {
	return {ctor: 'WakeUpResponseReceived', _0: a};
};
var _user$project$Payments$wakeUpHeroku = A2(
	_elm_lang$http$Http$send,
	_user$project$Payments$WakeUpResponseReceived,
	_elm_lang$http$Http$getString('https://stcs-pay.herokuapp.com'));
var _user$project$Payments$init = {
	ctor: '_Tuple2',
	_0: {state: _user$project$Payments$WaitingForForm, serverAwake: false},
	_1: _user$project$Payments$wakeUpHeroku
};
var _user$project$Payments$ServerResponseReceived = function (a) {
	return {ctor: 'ServerResponseReceived', _0: a};
};
var _user$project$Payments$makeCharge = function (body) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Payments$ServerResponseReceived,
...
var _user$project$Payments$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'FromJs':
				var _p4 = A2(
					...
					A2(
						_elm_lang$core$Json_Decode$decodeValue,
						_user$project$Payments$formDataDecoder,
						A2(_elm_lang$core$Debug$log, 'json', _p3._0)));
				if (_p4.ctor === 'Ok') {
					var _p7 = _p4._0;
					var _p5 = _elm_lang$core$String$toFloat(_p7.amount);
					if (_p5.ctor === 'Ok') {
						var _p6 = _p7.result.token;
						if (_p6.ctor === 'Nothing') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										state: _user$project$Payments$BadInputData(
											A2(
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{state: _user$project$Payments$WaitingForServer}),
								_1: _user$project$Payments$makeCharge(
									A3(_user$project$Payments$chargeBody, _p5._0, _p6._0.id, _p7))
							};
						}
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									state: _user$project$Payments$BadInputData(_p5._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$Payments$BadInputData(_p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ServerResponseReceived':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{state: _user$project$Payments$Complete}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$Payments$Failed(_p3._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'WakeUpResponseReceived':
				if (_p3._0.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _user$project$Payments$WaitingForStripeToken}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Payments$main = _elm_lang$html$Html$program(
	{init: _user$project$Payments$init, update: _user$project$Payments$update, view: _user$project$Payments$view, subscriptions: _user$project$Payments$subscriptions})();

var Elm = {};
Elm['Payments'] = Elm['Payments'] || {};
if (typeof _user$project$Payments$main !== 'undefined') {
    _user$project$Payments$main(Elm['Payments'], 'Payments', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Payments.Msg":{"args":[],"tags":{"FromJs":["Json.Encode.Value"],"WaitForStripeToken":[],"WakeUpResponseReceived":["Result.Result Http.Error String"],"ServerResponseReceived":["Result.Result Http.Error String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Payments.Msg"},"versions":{"elm":"0.18.0"}});
}
