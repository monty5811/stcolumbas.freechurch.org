...
var _user$project$Main$chargeBody = F3(
...
var _user$project$Main$niceHttpErr = function (err) {
	var _p0 = err;
	switch (_p0.ctor) {
		case 'BadUrl':
			return {
		...
		default:
			return A2(
				...
				A2(
					...
					_user$project$Main$niceHttpErr(_p1._0)));
	}
};
var _user$project$Main$stripeResult = _elm_lang$core$Native_Platform.incomingPort('stripeResult', _elm_lang$core$Json_Decode$value);
var _user$project$Main$startLoading = _elm_lang$core$Native_Platform.incomingPort(
	'startLoading',
...
var _user$project$Main$FormData = F5(
	function (a, b, c, d, e) {
		return {name: a, amount: b, email: c, fund: d, result: e};
	});
var _user$project$Main$StripeResult = F2(
	function (a, b) {
		return {token: a, error: b};
	});
var _user$project$Main$StripeToken = function (a) {
	return {id: a};
};
var _user$project$Main$stripeTokenDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'id',
	_elm_lang$core$Json_Decode$string,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$StripeToken));
var _user$project$Main$StripeError = F5(
	function (a, b, c, d, e) {
		return {charge: a, message: b, code: c, declineCode: d, param: e};
	});
var _user$project$Main$stripeErrorDecoder = A4(
		...
		A4(
			...
			A4(
				...
				A3(
					...
					'charge',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$StripeError))))));
var _user$project$Main$stripeResultDecoder = A4(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
	'error',
	_elm_lang$core$Json_Decode$maybe(_user$project$Main$stripeErrorDecoder),
	_elm_lang$core$Maybe$Nothing,
	A4(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
		'token',
		_elm_lang$core$Json_Decode$maybe(_user$project$Main$stripeTokenDecoder),
		_elm_lang$core$Maybe$Nothing,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$StripeResult)));
var _user$project$Main$formDataDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'result',
	_user$project$Main$stripeResultDecoder,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'fund',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			A3(
				...
				A3(
					...
					'name',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$FormData))))));
var _user$project$Main$Failed = function (a) {
	return {ctor: 'Failed', _0: a};
};
var _user$project$Main$Complete = {ctor: 'Complete'};
var _user$project$Main$WaitingForServer = {ctor: 'WaitingForServer'};
var _user$project$Main$BadInputData = function (a) {
	return {ctor: 'BadInputData', _0: a};
};
var _user$project$Main$WaitingForStripeToken = {ctor: 'WaitingForStripeToken'};
var _user$project$Main$WaitingForForm = {ctor: 'WaitingForForm'};
var _user$project$Main$WaitForStripeToken = {ctor: 'WaitForStripeToken'};
...
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$stripeResult(_user$project$Main$FromJs),
			_1: {
				ctor: '::',
				_0: _user$project$Main$startLoading(
					function (_p2) {
						return _user$project$Main$WaitForStripeToken;
					}),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$WakeUpResponseReceived = function (a) {
	return {ctor: 'WakeUpResponseReceived', _0: a};
};
var _user$project$Main$wakeUpHeroku = A2(
	_elm_lang$http$Http$send,
	_user$project$Main$WakeUpResponseReceived,
	_elm_lang$http$Http$getString('https://stcs-pay.herokuapp.com'));
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: {state: _user$project$Main$WaitingForForm, serverAwake: false},
	_1: _user$project$Main$wakeUpHeroku
};
var _user$project$Main$ServerResponseReceived = function (a) {
	return {ctor: 'ServerResponseReceived', _0: a};
};
var _user$project$Main$makeCharge = function (body) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$ServerResponseReceived,
		...
		switch (_p3.ctor) {
			case 'FromJs':
				var _p4 = A2(
					...
					A2(
						_elm_lang$core$Json_Decode$decodeValue,
						_user$project$Main$formDataDecoder,
				...
				if (_p4.ctor === 'Ok') {
						...
						if (_p6.ctor === 'Nothing') {
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{
										state: _user$project$Main$BadInputData(
											A2(
							...
							return {
								...
								_0: _elm_lang$core$Native_Utils.update(
									model,
									{state: _user$project$Main$WaitingForServer}),
								_1: _user$project$Main$makeCharge(
									A3(_user$project$Main$chargeBody, _p5._0, _p6._0.id, _p7))
							};
						}
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									state: _user$project$Main$BadInputData(_p5._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$Main$BadInputData(_p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			case 'ServerResponseReceived':
				if (_p3._0.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{state: _user$project$Main$Complete}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: _user$project$Main$Failed(_p3._0._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
			...
			default:
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{state: _user$project$Main$WaitingForStripeToken}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"FromJs":["Json.Encode.Value"],"WaitForStripeToken":[],"WakeUpResponseReceived":["Result.Result Http.Error String"],"ServerResponseReceived":["Result.Result Http.Error String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
